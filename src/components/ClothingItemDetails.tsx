      ...
      <DialogContent className="max-w-md max-h-[90vh] overflow-auto">
        {viewMode === "outfit" && selectedOutfit ? (
          ...
          <>
            ...
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-md mb-4 bg-secondary/20">
              <img 
